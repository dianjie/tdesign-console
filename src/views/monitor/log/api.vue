    ...
    <div class="table-wrapper">
      ...
      >
        <template #op="slotProps">
          <a v-auth="'log_api_view'" class="t-button-link" @click="handleAction(slotProps, 'view')">查看</a>
        </template>
      </t-table>
...
import { getList } from '@/api/log/api';
import { useSetting } from '@/hooks/setting/useSetting';
import { useDesign } from '@/hooks/web/useDesign';
import { useRequset } from '@/hooks/web/useRequset';
import { noop } from '@/utils';
import DialogForm from '@/viewsBusiness/monitor/log/components/api/DialogForm.vue';
import { COLUMNS } from '@/viewsBusiness/monitor/log/constant/api/constant';
