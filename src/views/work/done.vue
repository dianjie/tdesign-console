    ...
    <div class="table-wrapper">
      ...
      >
        <template #op="slotProps">
          <a v-auth="'work_done_detail'" class="t-button-link" @click="handleDetail(slotProps)">详情</a>
          <a v-auth="'work_done_follow'" class="t-button-link" @click="handleImage(slotProps)">流程图</a>
        </template>
...
import { COLUMNS } from '@/viewsBusiness/work/constant/done/constant';
...
const { fetchData: oldFetchData, data, pagination, dataLoading } = useRequset(doneList, formData.value, noop);
